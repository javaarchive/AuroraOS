...
document.getElementById(`${package.name}About`).onclick = function() { package.createWindow(`<div id="%window%TitleBar" class="windowTitleBar blur"><div id="%window%Close" class="windowAction"><img src="close.svg"></div>About auroraOS</div><div id="%window%Body" class="windowBody blur" style="text-align:center;"><a href="https://github.com/soupy-developer/auroraOS"><img src="logo.webp" style="float:left;margin-right:15px;"></a><h1 style="float:right;margin-top:20px;margin-left:45px;margin-right:45px;">auroraOS</h1> <p><strong>Build</strong> 84</p> <p><strong>Version</strong> 4.5</p> <p>Made with love by <a href="https://discord.gg/8nFuT3d">soup</a></p> <h2>Open-source licenses</h2><a href="https://jquery.com/">jQuery & jQueryUI - The jQuery Foundation</a> <br><a href="https://github.com/daneden/animate.css">Animate.css - daneden</a></div>`); };
